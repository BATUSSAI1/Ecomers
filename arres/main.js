...
function printObjet(database) {
  ...
  for (const products of database.objets) {
...
function botonFilter(database){
  ...
  botonesHTML.forEach(function (boton) {
    ...
    boton.addEventListener("click", function(e){
      ...
      // console.log(botoFilter);
      if(botoFilter === "all"){
        console.log(printObjet(database))
        printObjet(database);
...
async function star() {
  const database = {
    ...
    cars: 
      JSON.parse(window.localStorage.getItem("caris"))|| {},
